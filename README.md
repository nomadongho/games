...
A collection of games by nomadongho. Each game is located under the `games/` folder.

## Game List

| Folder | Game Name | Description |
|--------|-----------|-------------|
| [games/Game](games/Game/) | Echo Hunt | A hunting game using sound waves |
| [games/Game2](games/Game2/) | Quantum Cascade ⚛ | A quantum chain reaction puzzle game |
| [games/Game3](games/Game3/) | ALIEN ASSAULT 2185 | A shooting game fighting alien invaders |
...
Open the `index.html` file in any game folder directly in your browser, or
open the root [index.html](index.html) to see the full game list.